...
- `COLLABORATION_GOLDEN_RULES.md` (QA & Collaboration)
- `RESPONSIBILITY_MATRIX.md` (RACI Matrix)
- `PromptRuler_Workflow.md` (Workflow Protocol)
- `GIT_GUIDE.md` (Integrity & History)
</step_1>

<step_2 title="Experience Ingestion">
Read the current project traces and memory in `docs/02_BODY/`:
- `COGNITIVE_TASK_REGISTRY.md` (Current Goals & Task Status)
- `ValidatedTaskSequences.md` (Success Patterns)
- `INTENTION_INBOX.md` (Unstructured Input Processing)
</step_2>
...
<initialization_report>
  <genotype_status>G-Genome v1.2.0 Industrial Active</genotype_status>
